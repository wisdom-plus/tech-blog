const Page = () => {
  return (
    <div className='max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0'>
      <div className='w-full rounded-lg lg:rounded-l-lg shadow-2xl opacity-75 mx-6 lg:mx-0 bg-gray-900'>
        <div className='p-4 md:p-12 text-center lg:text-left'>
          ...
          <p className='pt-2 text-sm'>
            1997年3月26日に大阪に生まれる。数度の転校をし大阪府枚方市に移住
          </p>
          <p className='pt-2 text-sm'>2015年3月に長尾高校を卒業。公務員を目指しフリーターになる</p>
          <p className='pt-2 text-sm'>2年試験に落ち公務員になるのを諦める</p>

          <div className='mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center'>
            <a className='link mr-6' href='#' data-tippy-content='@twitter_handle'>
              <svg
